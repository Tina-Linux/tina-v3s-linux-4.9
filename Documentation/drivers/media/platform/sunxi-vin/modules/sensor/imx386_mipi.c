...
static int tmp_exp_val, tmp_gain_val = -1;
			     ...
			     struct sensor_exp_gain *exp_gain)
{
	...
	if (tmp_gain_val == exp_gain->gain_val && tmp_exp_val == exp_gain->exp_val)
		return 0;
	else {
...
static struct sensor_win_size sensor_win_sizes[] = {
	...
	.set_size      = NULL,
	.top_clk       = 274*1000*1000,
	.isp_clk       = 274*1000*1000,
	 },
	...
	.set_size      = NULL,
	.top_clk       = 288*1000*1000,
	.isp_clk       = 288*1000*1000,
	 },
	...
	.set_size      = NULL,
	.top_clk       = 278*1000*1000,
	.isp_clk       = 278*1000*1000,
	 },
	...
	.set_size      = NULL,
	.top_clk       = 258*1000*1000,
	.isp_clk       = 258*1000*1000,
	 },
...
static int sensor_reg_init(struct sensor_info *info)
{
	...
	/*in case of AE unusual  after CSI suspend-resume or switch scene*/
	tmp_gain_val = -1;
	tmp_exp_val = -1;
