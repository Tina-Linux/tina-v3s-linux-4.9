...
extern struct axp_dev *axp20x_get_pmu_dev_pointer(void);
...
int axp20x_gpio_get_value(int gpio, int *value)
{
	struct axp_dev *axp_dev = axp20x_get_pmu_dev_pointer();
	 *value = axp20x_gpio_get_data(axp_dev,gpio);
	 return *value;
}
EXPORT_SYMBOL_GPL(axp20x_gpio_get_value);
...
int axp20x_gpio_set_value(int gpio, int value)
{
	struct axp_dev *axp_dev = axp20x_get_pmu_dev_pointer();
	return axp20x_gpio_set_data(axp_dev,gpio,value);
}
EXPORT_SYMBOL_GPL(axp20x_gpio_set_value);
